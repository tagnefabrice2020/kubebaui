                            ...
                            <div className="tile is-parent is-vertical contianer-height">
                                ...
                                <div className="m-b-10 is-flex is-flex-direction-row is-justify-content-space-between is-align-items-center">
                                    ...
                                    <div className="buttons has-addons">
                                        <button className="button is-primary is-selected is-small">Logins</button>
                                        <button className="button is-small">Parcels</button>
                                        <button className="button is-small">Clients</button>
                                    </div>
                                </div>
